            ...
            <div className="col-12 col-sm-12 col-md-6">
                <div className="card">
                    <div className="card-body">
                        <h4 className="card-title">Upade Product</h4>
                        <hr />
                        <div className="form-wrapper">
                            ...
                            <Form onSubmit={updateProduct}>
                                ...
                                <Row>
                                    <Col>
                                        <div>
                                            <img width={50} height={50} src={`http://localhost:8000/storage/product/image/${oldimage.image}`} alt="" />
                                        </div>
